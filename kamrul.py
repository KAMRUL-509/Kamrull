...
try:
	prox= requests.get('https://github.com/KAMRUL-509/Kamrull/blob/main/proxies.txt').text
...
android_models=[]
try:
	xx = requests.get('https://github.com/KAMRUL-509/Kamrull/blob/main/proxies.txt').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://github.com/KAMRUL-509/Kamrull/blob/main/proxies.txt').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
...
def menu():
	 ...
	 #          os.system('xdg-open https://www.facebook.com/profile.php?id=100089542576804')
			if xd in ['1','01']:
				clear()
